        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-muted/30 border border-border rounded-xl p-4">
            ...
            <div className="flex gap-2">
              <select value={routeAlgo} onChange={(e) => setRouteAlgo((e.target.value === "dijkstra" ? "dijkstra" : "astar") as "astar" | "dijkstra")} className="bg-background border border-border rounded-lg px-2 py-1 text-xs text-foreground">
