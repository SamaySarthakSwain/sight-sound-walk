...
const monumentsByCategory = {
  ...
  nearby: [
    ...
    {
      title: "Chilika Lake",
      description: "Asia's largest brackish water lagoon, about 100 km from Bhubaneswar. Home to migratory birds and famous Irrawaddy dolphins. OTDC offers lake cruises from various entry points.",
  ...
  beaches: [
    {
      title: "Puri Beach",
      description: "One of the most famous beaches in India, about 60 km from Bhubaneswar. Known for its golden sands, the annual Sand Art Festival, and proximity to the sacred Jagannath Temple.",
      location: "60 km from Bhubaneswar, Puri",
      category: "Beach",
      imageUrl: jagannathImage,
      facts: [
    ...
    },
    {
      ...
      description: "One of the cleanest and most scenic beaches on the eastern coast. This serene beach town features an old lighthouse, sea-view resorts, and was once a busy colonial port.",
      location: "180 km from Bhubaneswar, Ganjam",
      category: "Beach",
      imageUrl: gopalpurImage,
      facts: [
        "180 km from Bhubaneswar",
    ...
    },
    {
      ...
      description: "A pristine beach near Konark Sun Temple, about 68 km from Bhubaneswar. Known for its clean sands and the famous Chandrabhaga Mela held annually.",
      location: "68 km from Bhubaneswar, Konark",
      category: "Beach",
      imageUrl: konarkImage,
      facts: [
        "68 km from Bhubaneswar",
        "Near Konark Sun Temple",
        "Famous Chandrabhaga Mela",
        "Clean and pristine sands",
        "Ideal for morning walks and sunrises"
      ]
    }
  ],
  forts: [
    ...
    {
      title: "Sisupalgarh Fort",
      description: "Ancient fortified city ruins dating back to 3rd century BCE, located just 5 km from Bhubaneswar. One of the largest and best-preserved early historic fortifications in India.",
      location: "5 km from Bhubaneswar, Odisha",
      category: "Fort",
      imageUrl: barabatiImage,
      facts: [
        "5 km from Bhubaneswar",
        "Dating back to 3rd century BCE",
        "Ancient fortified city ruins",
        "One of largest early historic fortifications",
